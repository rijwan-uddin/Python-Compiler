    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=> variable()));// Navigate to desired screen here
            },
            child: Container(
              height: 50,
              width: 10,
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context)=> datatype()));// Navigate to desired screen here
            },
            child: Container(
              height: 50,
              width: 10,
